...
**pb** il faut refaire le dosssier à la main le doossier avec full droit et shares et quqand ajoute packet zip on fait le lien réséeau (avec //) car sinon le serveurM va chercher en local un chemin qu'il n'a pas.
